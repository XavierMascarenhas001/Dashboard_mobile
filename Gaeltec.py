...
# -------------------------------
    ...
    for cat_name, keys, y_label in categories:
        ...
        if selected_mapping:
            ...
            display_cols = ['Output','pole','Quantity','Date','District','project','Project Manager','Circuit','Segment','team_name','PID', 'sourcefile']
            ...
            with pd.ExcelWriter(buffer_agg, engine='openpyxl') as writer:
                ...
                for bar_value in bar_data['Mapped']:
                    ...
                    cols_to_include = ['Output','pole','Quantity','Date','District','Project Manager','Circuit','Segment','PID'] + extra_cols
